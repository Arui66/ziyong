...
class UserInfo {
    constructor(str) {
        ...
        this.headersPost = {
            ...
            'ua': 'duapp/5.9.0(android;12)',
            'SK': this.SK,
            'shumeiId': this.shumeiId,
            'deviceTrait': '21051182C',
            ...
            'User-Agent': 'Mozilla/5.0 (Linux; Android 12; 21051182C Build/SKQ1.220303.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/109.0.5414.85 Safari/537.36/duapp/5.9.0(android;12)',
